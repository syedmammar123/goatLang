...
import { Program } from '../Parsing/Classes.js'
    ...
    try {
        ...
        ast.body.forEach((elem) => {
            if (
                ...
                elem?.type === 'AssignmentExpression'
            ) {
                dataAst.push(elem)
            }
        })
...
console.log(
    chalk.green('Welcome to '),
    chalk.bgRedBright.underline.italic.bold(' GoatLang '),
    chalk.green(' programming Language.'),
)
repl()
